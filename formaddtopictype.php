...
<body>
    ...
    <div class="body-content">
        <div class="container-addtopic">
            ...
            <form action="action_addtopictype.php" method="post">
                <div>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td><textarea name="topic_type_name" required></textarea></td>
                        </tr>
                        <tr>
                            <td class="title-table"><b>Mô tả</b></td>
                            <td> <textarea name="topic_type_description" rows="2"></textarea></td>
                        </tr>
