    ...
    <div class="body-content">
        ...
        <div class="infor-list">
            <div class="w3-content">
                <!-- <button class="next-back-slides" onclick="plusDivs(-1)">&#10094;</button> -->
                <div>
                    <img class="mySlides" src="img/bg-img/slide1.jpg">
                    <img class="mySlides" src="img/bg-img/slide2.jpg">
                    <img class="mySlides" src="img/bg-img/slide3.jpg">
                </div>
                <!-- <button class="next-back-slides" onclick="plusDivs(1)">&#10095;</button> -->
            </div>
            <?php
            if ($count > 0) {
                while ($numrows = mysqli_fetch_array($result)) {
                    $id_news = $numrows['id_news'];
                    $title_news = $numrows['title_news'];
                    $title_content = $numrows['title_content'];
                    $content_news = $numrows['content_news'];
                    $date_news = $numrows['date_news'];
                    ?>
                    <div class="infor-title">
                        <h5> <a href="newsdetail.php?id=<?php echo   $id_news ?>"> <?php echo  $title_news  ?></a></h5>
                        <span><?php echo $date_news ?></span>
